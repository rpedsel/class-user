...
public class BookmarkRestControllerTest {
    ...
    public void setup() throws Exception {
        ...
        this.bookmarkList.add(bookmarkRepository.save(new Bookmark(user, "http://bookmark.com/1/" + lastName, "A description")));
        this.bookmarkList.add(bookmarkRepository.save(new Bookmark(user, "http://bookmark.com/2/" + lastName, "A description")));
    }
